...
| Access and Restic recovery | The plan transport and deploy activator are retired in both source and installed state. The later [VM9900 retirement](vm9900-retirement-assessment.md) also removed the Restic-only deploy transport, locked its Proxmox account and retired the dedicated sudo/Tailscale route. Generic backup/recovery and autonomous firewall access remain independent. |
