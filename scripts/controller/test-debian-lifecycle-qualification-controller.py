...
contract=module.contract_image(); target={"bridge":"vmbr-qualification","controller_ipv4":"198.51.100.12","disk_datastore_id":"qualification-lvm","image_datastore_id":"qualification-dir","node_name":"pve-qualification","snippet_file_id":"local:snippets/home-lab-debian-lifecycle-qualification.yaml"}
def item(address,after): return {"address":address,"change":{"actions":["create"],"after":after}}
plan={"resource_changes":[
 item("proxmox_download_file.qualification_image[0]",{"checksum":contract["sha512"],"checksum_algorithm":"sha512","datastore_id":"qualification-dir","node_name":"pve-qualification","overwrite":False,"url":contract["url"]}),
 item("proxmox_virtual_environment_vm.qualification[0]",{"boot_order":["scsi0"],"disk":[{"datastore_id":"qualification-lvm","interface":"scsi0","serial":"DEB-LIFE-ROOT-32G","size":32}],"initialization":[{"datastore_id":"qualification-lvm","dns":[{"servers":["1.1.1.1","9.9.9.9"]}],"upgrade":False,"user_data_file_id":"local:snippets/home-lab-debian-lifecycle-qualification.yaml"}],"network_device":[{"bridge":"vmbr-qualification","firewall":True}],"node_name":"pve-qualification","on_boot":False,"protection":False,"reboot_after_update":False,"started":False,"vm_id":9900}),
