...
target={"disk_datastore_id":"local-lvm","image_datastore_id":"local","node_name":"proxmox"}; image=module.common.contract_image(); vm="proxmox_virtual_environment_vm.qualification[0]"; image_address="proxmox_download_file.qualification_image[0]"; options="proxmox_virtual_environment_firewall_options.qualification[0]"; rules="proxmox_virtual_environment_firewall_rules.qualification[0]"; addresses=[image_address,options,rules,vm]
...
for required in ("START_PRODUCTION_PVE_DISPOSABLE_DEBIAN_9900","DESTROY_PRODUCTION_PVE_DISPOSABLE_DEBIAN_9900","plan-start","apply-start","plan-destroy","apply-destroy","prior_receipt_sha256","snippet_receipt_sha256","approve_authorization_sha","tofu-{operation}-apply-no-retry","-destroy","locked_setup","state-drift"):
