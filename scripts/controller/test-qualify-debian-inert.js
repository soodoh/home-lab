...
const packageShutdownIndex = script.indexOf("stage=shutdown-debian-after-package-preparation");
const prepareRebootIndex = script.indexOf("stage=prepare-arch-host-reboot");
const awaitingIndex = script.indexOf('mark_package_evidence_awaiting_reboot "', packageIndex);
assert.ok(packageIndex < pendingIndex && pendingIndex < packageShutdownIndex && packageShutdownIndex < prepareRebootIndex && prepareRebootIndex < awaitingIndex);
