...
assert.ok(script.indexOf("stage=prepare-debian-packages") < script.indexOf("  restore_arch\n  transition_started=false"));
assert.ok(script.indexOf("  restore_arch\n  transition_started=false") < script.indexOf('mv -T "$PREPARE_LOG.pending" "$PREPARE_LOG"'));
