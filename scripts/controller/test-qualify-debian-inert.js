...
assert.match(script, /\(\$prepare_mode == true \|\| \$rehearsal_mode == true \|\| \$identity_mode == true \|\| \$credentials_mode == true\) && \$transition_started == true[\s\S]*prepare_arch_host_reboot_path/);
