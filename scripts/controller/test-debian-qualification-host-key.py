...
for required in ("--read-only","--format=raw","VM9900 is not stopped","VM9900 stopped lock precondition",'\"/usr/sbin/qm\",\"set\"','\"/usr/sbin/qm\",\"unlock\"','\"/usr/bin/partx\",\"--add\"','\"/usr/bin/partx\",\"--delete\"',"O_DIRECTORY|os.O_NOFOLLOW","local-lvm:vm-9900-disk-0","ro,noload,nodev,nosuid,noexec","ssh_host_ed25519_key.pub","host-key extraction cleanup failed"):
