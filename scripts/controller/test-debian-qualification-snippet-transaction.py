...
with tempfile.TemporaryDirectory() as directory:
 ...
 for required in ('return "/var/lib/vz/snippets","/run/lock/home-lab-disposable-qualification.lock"', "os.O_NOFOLLOW", "os.fsync", "os.link", "LOCK_EX|fcntl.LOCK_NB", "plan stale", "snippet precondition drift"):
