...
class Tests(unittest.TestCase):
 def test_activation_validation_refuses_authority_drift(self):
  value={"format":"home-lab-debian-reboot-activation-v1","host":"debian","created_at":"2026-09-03T10:00:00Z","expires_at":"2026-09-03T10:30:00Z","expected":{"boot_id":"1","current_kernel":"old","target_kernel":"new"},"conflict_locks":[],"inactive_backup_units":[],"workload_order":["compose-drain","host-reboot","host-audit"],"postchecks":["kernel","mounts","docker","compose","restic-timers","tailscale","production-audit"],"automatic_reboot":False,"authorized":False}
