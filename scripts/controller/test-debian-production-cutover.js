...
assert.match(failedReconcile, /\.phase != "committed"/);
...
assert.ok(coordinator.includes("failed_reconcile_sha=d3797fbc93ebf0dc28f10cbac5ff06f84610edab20f664beb5a4c84ced5f9160"));
...
assert.ok(coordinator.includes('for device in zigbee zwave; do [[ -L /dev/$device && -c $(readlink -f "/dev/$device") ]]'));
