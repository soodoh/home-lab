...
def cases(now):
    ...
    o=base(); m=mount(True); o["mounts"]=[m]; o["identity"]={"exists":True,"path":"/etc/home-lab/age/keys.txt","recipient":"age1testrecipient","uid":0,"gid":0,"mode":"0600","regular":True,"symlink":False,"nlink":1}; o["tailscale"]={"backend_state":"Running","hostname":"docker-host","tags":["tag:docker-host"],"node_id":"node-test","addresses":["100.64.0.1"],"run_ssh":False}; o["production"]={"lifecycle_marker_sha256":"a"*64,"compose_artifact_sha256":"2"*64,"compose_image_lock_sha256":"3"*64,"compose_config_valid":True,"restic_recovery_receipt_sha256":"4"*64,"root_environment_protected":True,"root_environment_sha256":"6"*64,"systemd_dependencies":deepcopy(TEST_POLICY["transaction"]["production_systemd_dependencies"]),"systemd_unit_states":{unit:"inactive" for unit in TEST_POLICY["transaction"]["production_units"]},"storage_plan_sha256":"5"*64,"compose_artifact_path":"/etc/home-lab/compose.yml","compose_image_lock_path":"/etc/home-lab/images.json","restic_recovery_receipt_path":"/etc/home-lab/restic-recovery.json","compose_command":["/usr/bin/docker","compose"],"root_environment_path":"/etc/home-lab/compose.env"}
    o["format"]="home-lab-debian-lifecycle-observation-v2"
